...
// {
// 	map<std::string, int>::iterator itr = mParticleEffectMap.find(effectName);
//
// 	if (itr == mParticleEffectMap.end())
// 	{
// 		std::string path = mResourceRoot + effectName;
...
// {
// 	map<std::string, int>::iterator itr = mMotionEmitterMap.find(emitterName);
//
// 	if (itr == mMotionEmitterMap.end())
// 	{
// 		std::string path = mResourceRoot + emitterName;
// 		printf("creating effect:%s\n", path.c_str());
