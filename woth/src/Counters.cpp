...
int Counters::addCounter(const char* _name, int _power, int _toughness) {
    /*420.5n If a permanent has both a +1/+1 counter and a -1/-1 counter on it, N +1/+1 and N -1/-1 counters are removed
     * from it, where N is the smaller of the number of +1/+1 and -1/-1 counters on it.*/
