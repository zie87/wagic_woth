...
public:
    ...
    virtual bool HandleSelection(JButton inKey) {
        ...
        for (size_t index = 0; index < mCards.size(); ++index) {
            ...
            // wouldn't let you move in certain directions when a card looked reachable. instead, I'm using a different
            // logic - if there's a card in the direction that you're stepping, and it's within a defined radius, go for
            // it.
