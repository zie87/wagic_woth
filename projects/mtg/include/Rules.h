...
public:
    GamePhase phase;
    int player;
    void parsePlayerState(int playerId, const std::string& s);
    RulesState();
...
protected:
    ...
    GameType strToGameMode(const std::string& s);
...
public:
    ...
    static Rules* getRulesByFilename(const std::string& _filename);
    ...
    static int getMTGId(const std::string& name);
